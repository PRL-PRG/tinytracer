...
get_metadata <- function(path, common_prefix="/home/kondziu/Workspace/tinytracer/results/") {
...
#jit_path <- "/home/vignettes/_results/18-10-12_15-08/cropped_jit/"
#jit_path <- "/home/kondziu/Workspace/tinytracer/results/18-10-17_16-30/composition_jit/cropped/"
jit_path <- "/home/kondziu/Workspace/tinytracer/results/18-10-18_16-08/composition/jit/cropped/"
jit_metadata <- get_metadata(jit_path)
jit_data <- get_data_and_merge(jit_path)

#nojit_path <- "/tmp/vignettes/_results/18-10-12_15-08/cropped_nojit/"
#nojit_path <- "/home/kondziu/Workspace/tinytracer/results/18-10-17_16-30/composition_nojit/cropped/"
nojit_path <- "/home/kondziu/Workspace/tinytracer/results/18-10-18_16-08/composition/disable_bytecode/cropped/"
nojit_metadata <- get_metadata(nojit_path)
nojit_data <- get_data_and_merge(nojit_path)
```
